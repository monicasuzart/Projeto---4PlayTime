...
session_start();
$consulta = "SELECT a.*, e.nome FROM atividades a, estudante e where a.id_Estudante = e.id_Estudante AND e.id_Estudante = ". $_SESSION["id_Estudante"]; 
...
<b class="p"> Status:</b>
	...
	<td class="p">
<b class="b"><?php echo $dado["status"]; ?></b></br>
	</td>
</tr>
